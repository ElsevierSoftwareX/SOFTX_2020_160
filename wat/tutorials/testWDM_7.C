{  // residuals with increased precision (4th parameter in the WDM constructor)
   ...
   WDM<double> wdm(32, 64, 6, 12);  // define a WDM transform (32 bands, increased precision (12)) 
   ...
   TH1F* h = new TH1F("h", "Residuals, P=12", 100, -3e-6, 3e-6);
