// Coherent WaveBurst production script for 4 detector network
{
  int  i,j,n,m;

  cout<<"\n network of "<<ifo[0]<<"x"<<ifo[1]<<"x"<<ifo[2]<<"x"<<ifo[3]<<" detectors\n\n";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	...
	cout<<"total    pixels: "<<NET.coherence4(Ao)<<"  ";
	...
	cout<<"selected pixels: "<<NET.likelihood4('E',false,Acore)<<"\n";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    for(i=l_low; i<=l_high; i++) {
      NET.setDelayFilters(&Do[i],mTau+0.002);
      cout<<"correlated energy for level "<<i<<": "<<NET.likelihood4('c',false,Acore)<<"\n";
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    for(i=l_high; i>=l_low; i--) {
      NET.setDelayFilters(&Do[i],mTau+0.002);
      cout<<"final likelihood  for level "<<i<<": "<<NET.likelihood4('h',false,Acore)<<"\n";
      NET.setRank(8.);  
      if(i>l_low) NET.Inverse(1);         
    }
