//////////////////////////////////////////////////////////////////
//   x-correlation class to define x-cor samples in raw root file
...
//List of branches
   ...
   xcsample() {fChain=NULL;};
   xcsample(TTree *tree) {if(tree) Init(tree);};
   virtual ~xcsample() { if (!fChain) return; delete fChain->GetCurrentFile(); };

   virtual xcsample& operator=(xcsample &);
