{
  ...
  double bpp   = 0.0005;   // probability for pixel selection
  ...
  char fileNamesRaw[2][50]={"llo.lst.","lho1.lst."};

  char channelNamesRaw[2][50]={"L1:LSC-STRAIN","H1:LSC-STRAIN"};

  char channelNamesMDC[2][50]={"L1:GW-H","H1:GW-H"};
