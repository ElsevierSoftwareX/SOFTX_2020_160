...
xcsample& xcsample::operator=(xcsample& a)
{
  fChain=                NULL;             
  fCurrent=              a.fCurrent;                                                        
  nevent=                a.nevent;             
...
//++++++++++++++++++++++++++++++++++++++++++++++
// set noise xcsample tree
//++++++++++++++++++++++++++++++++++++++++++++++
TTree* xcsample::setTree()
{
   TTree* waveTree = new TTree("xcsample","xcsample");
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++
// dump noise xcsample into tree
//++++++++++++++++++++++++++++++++++++++++++++++++++++
void xcsample::output(TTree* waveTree, wavecor& c)
{
   size_t i;
...
Int_t xcsample::GetEntry(Int_t entry) 
{ 
  if (!fChain) return 0; 
  return fChain->GetEntry(entry); 
};

void xcsample::Show(Int_t entry)
{
...
/*
Int_t xcsample::LoadTree(Int_t entry)
{
...
Int_t xcsample::Cut(Int_t entry)
{
