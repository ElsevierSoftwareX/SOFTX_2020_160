{
  ...
  double x2or  = 0.5;      // 2 OR threshold
  ...
  double delta = 0.02;    // fixed lenght constraint
  ...
  double shift[2] = {0.,0.};  // constant time shift
  ...
  char fileNamesRaw[2][50]={"lho1.lst.","lho2.lst."};

  char channelNamesRaw[2][50]={"H1:LSC-STRAIN","H2:LSC-STRAIN"};

  char channelNamesMDC[2][50]={"H1:GW-H","H2:GW-H"};
