...
addSGBurst(yp, 50.e-22, 280., 0.02);
addCGBurst(yx, 50.e-22, 280., 0.02);
//yx=0;
double avr,rms;
...
//   L1.writeFilter("/home/klimenko/wat/wat-4.0.RH/data/Meyer1024_L7.dat");
    ...
    gSystem->Exec("date");
    cout<<"core pixels: "<<NET.coherence3(Ao,4.,0.)<<"  "<<endl;
    ...
    gSystem->Exec("date");
    cout<<"  pixels: "<<NET.likelihood3('l', true,1.67);
    NET.corrcut(0.1,10,0);                             // remove large glitches
    cout<<"|"<<NET.likelihood3('l',false,1.67);
