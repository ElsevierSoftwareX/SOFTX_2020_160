{
  ...
  int levelR   = 2;        // downsampling by 2^levelR
  int levelF   = 6;        // level where LPR filter is applied
  ...
  double shift[4] = {0., 0., 0., 0.}; // constant time shift
  ...
  char fileNamesRaw[4][50]={"llo.lst.","lho1.lst.","lho2.lst.","virgo.lst."};

  char channelNamesRaw[4][50]={"L1:LSC-STRAIN","H1:LSC-STRAIN","H2:LSC-STRAIN","V1:LSC-STRAIN"};

  char channelNamesMDC[4][50]={"L1:GW-H","H1:GW-H","H2:GW-H","V1:GW-H"};
