{
  ...
  inspOptions+= "--min-mass1 2.5 --max-mass1 10.0 ";
  inspOptions+= "--min-mass2 2.5 --max-mass2 10.0 ";
  inspOptions+= "--min-mtotal 5.0 --max-mtotal 20. ";
  inspOptions+= "--min-mratio 0.25 --max-mratio 4.0 ";
  inspOptions+= "--min-distance 30000.0 --max-distance 45000.0 ";
  inspOptions+= "--waveform TaylorT1newtonian --disable-spin ";
  //inspOptions+= "--waveform TaylorF2 --disable-spin ";
  //inspOptions+= "--waveform EOBNRv2pseudoFourPN --disable-spin ";
  inspOptions+= "--taper-injection start --seed 123456789";

  MDC.SetInspiral("TaylorT1newtonian",inspOptions);
