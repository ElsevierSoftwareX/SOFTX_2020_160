...
// INPUT PLUGINS     :                                                       
// 
// 1 - CWB_Plugin_wavegraph_consistency_test.C
// 2 - /home/ecm/chirp_cwb/watrepo/tools/cwb/plugins/CWB_Plugin_MDC_OTF.C
// 3 - /home/ecm/chirp_cwb/watrepo/tools/cwb/plugins/CWB_Plugin_SimNoise.C
// 
// -------------------------------------------------------------------------
...
// 
// CWB_Plugin_wavegraph_consistency_test.C
// -------------------------------------------------------------------------
...
#define WAVEGRAPH_FILE  "config/wavegraph_2.5x2.5_25x25_TaylorF2_log_aLIGO_stripping_fl70_.txt"
...
// -------------------------------------------------------------------------
// --> BEGIN CWB_USER PLUGIN CODE 3
// 
// /home/ecm/chirp_cwb/watrepo/tools/cwb/plugins/CWB_Plugin_SimNoise.C
// -------------------------------------------------------------------------
...
namespace CWB_UserPluginNamespace_3 {
...
// Plugin to generate simulated gaussian noise
  ...
  cout << endl;
  cout << "-----> CWB_Plugin_GenNoise.C" << endl;
  cout << "ifo " << ifo.Data() << endl;
  cout << "type " << type << endl;
  cout << endl;
...
CWB_Plugin(TFile* jfile, CWB::config* cfg, network* net, WSeries<double>* x, TString ifo, int type)  {
  ...
  CWB_UserPluginNamespace_3::CWB_Plugin(jfile, cfg, net, x, ifo, type); // CALL USER PLUGIN CODE 3
}
