...
void 
Draw_FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a() {
...
/*
  #define MODE "inclusive"
  nFAR = 6;
  FAR_PATH[0]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_unmodeled.txt";
  FAR_PATH[1]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_constrained.txt";
  FAR_PATH[2]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
  FAR_PATH[3]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_unmodeled.txt";
  FAR_PATH[4]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_constrained.txt";
  FAR_PATH[5]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
*/
/*
  #define MODE "exclusive"
  nFAR = 6;
  FAR_PATH[0]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_eunmodeled.txt";
  FAR_PATH[1]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_econstrained.txt";
  FAR_PATH[2]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
  FAR_PATH[3]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_eunmodeled.txt";
  FAR_PATH[4]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_econstrained.txt";
  FAR_PATH[5]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
*/

// ===========================================================================
// C01+C01 h1_glitch_removed
// ===========================================================================

/*
  #define MODE "inclusive"
  nFAR = 6;
  FAR_PATH[0]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_unmodeled.txt";
  FAR_PATH[1]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_constrained.txt";
  FAR_PATH[2]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_chirp.txt";
  FAR_PATH[3]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_unmodeled.txt";
  FAR_PATH[4]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_constrained.txt";
  FAR_PATH[5]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
*/
  ...
  #define MODE "exclusive"
  nFAR = 6;
  FAR_PATH[0]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_eunmodeled.txt";
  FAR_PATH[1]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_econstrained.txt";
  FAR_PATH[2]="FARvsRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_h1_glitch_removed_chirp.txt";
  FAR_PATH[3]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_eunmodeled.txt";
  FAR_PATH[4]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_econstrained.txt";
  FAR_PATH[5]="FARvsLowRHO_ER8b_12Sep20Oct_C0101_BKG_LF_rMRA_run1ato10a_chirp.txt";
...
//sprintf(gTitle,"ER8b/O1 (C00) background of unmodeled/constrained/chirp data sets (Sep 12  - Oct 20)");
  ...
  //sprintf(gTitle,"ER8b/O1 (C01) background of edge/bulk/chirp data sets (Sep 12  - Oct 20)");
...
cout << nGR << endl;
  ...
  // save plot
#if ( MODE == "inclusive")
  //far_plot_name = "CompareFAR_C0101_UnModeled_Constrained_Chirp_run1ato10a_inclusive";
  far_plot_name = "CompareFAR_C0101_UnModeled_Constrained_Chirp_run1ato10a_h1_glitch_removed_inclusive";
#endif
#if ( MODE == "exclusive")
  //far_plot_name = "CompareFAR_C0101_eUnModeled_eConstrained_Chirp_run1ato10a_exclusive";
  far_plot_name = "CompareFAR_C0101_eUnModeled_eConstrained_Chirp_run1ato10a_h1_glitch_removed_exclusive";
#endif
  if(far_plot_name!="") {
    char gfileName[1024];
