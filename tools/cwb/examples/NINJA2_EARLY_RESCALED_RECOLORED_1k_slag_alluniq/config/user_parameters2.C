{
  ...
  search = 'I';       // see description in parameters.C
 ...
 // wavelet transformation settings
  ...
  // super lags
  slagSize   = 15;    // number of super lags (simulation=1) - if slagSize=0 -> Igor Segments
  slagMin    = 1;    // if slagMax=0 ->  slagMin must be < slagMax
