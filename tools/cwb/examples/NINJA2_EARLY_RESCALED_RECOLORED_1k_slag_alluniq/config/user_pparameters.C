...

{
 ...
 // T_cor      = 0.65;       // cc cut
  ...
  T_vED      = 0.4;        // vED threshold
  T_pen      = 0.6;        // penalty threshold
  T_out      = 4.0;        // output threshold

  //T_cut_veto = 6.9;        // rho high frequency cut
  //T_CUT_veto = 6.9;        // rho low frequency cut

  T_cut_veto = 4.0;        // rho high frequency cut
  T_CUT_veto = 4.0;        // rho low frequency cut
