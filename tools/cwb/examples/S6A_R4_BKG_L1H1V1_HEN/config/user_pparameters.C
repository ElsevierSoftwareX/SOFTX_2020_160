...
#define RUN_LABEL "S6A/VSR2 HEN - Built-in SkySeg"
...
/*
  ...
  T_vED      = 1.0;        // vED threshold
*/
  T_cor      = 0.7;        // cc cut
  T_cut      = 6.0;        // rho high frequency cut
  T_CUT      = 6.0;        // rho low frequency cut  (only for simulations)
  T_vED      = 0.25;       // vED threshold


  T_scc      = 0.0;        // subcc [2G]
  T_pen      = 0.0;        // penalty threshold
  T_out      = 3.0;        // output threshold

  T_cut_veto = 6.0;        // rho high frequency cut
  T_CUT_veto = 6.0;        // rho low frequency cut
