{
  ...
  factors[0] = 1.0;    // array of strain factors
  ...
  plugin = TMacro("macro/CWB_Plugin_HEN_BKG.C");               // Macro source
  configPlugin = TMacro("macro/CWB_Plugin_HEN_BKG_Config.C");  // Macro config
}
