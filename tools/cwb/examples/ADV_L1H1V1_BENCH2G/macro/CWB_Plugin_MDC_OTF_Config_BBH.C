...
void CWB_PluginConfig() {
  ...
  // Config Plugin to generate injected 'on the fly' BHBH from LAL

  cout << "Execute CWB_Plugin_MDC_OTF_Config_BBH.C ..." << endl;                                 
  ...
  TString inspOptions="";
  inspOptions = "--time-step 150.0 --time-interval 0 ";
  inspOptions+= "--gps-start-time 1096827000 --gps-end-time 1096967000 ";
  ...
  inspOptions+= "--min-mtotal 20. --max-mtotal 20. ";
  ...
  MDC->SetInspiral("BBH",inspOptions);
