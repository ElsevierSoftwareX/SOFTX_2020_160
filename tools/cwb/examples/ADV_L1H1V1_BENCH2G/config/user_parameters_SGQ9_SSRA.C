{
  ...
  SEARCH() = 'S';     // see description in parameters.C
  optim=true;
  ...
  double FACTORS[] ={20,40}; // array of strain factors
  ...
  strcpy(injectionList,"input/BNS.inj");
  ...
  configPlugin = TMacro("macro/CWB_Plugin_MDC_OTF_Config_SGQ9.C");  // Macro config
