{
  ...
  // file dump mode
  dump        = false;   // dump triggers into ascii file
  ...
  plugin = TMacro("macro/CWB_Plugin_SimNoise.C");        // Macro source
  plugin.SetTitle("macro/CWB_Plugin_SimNoise_C.so");
