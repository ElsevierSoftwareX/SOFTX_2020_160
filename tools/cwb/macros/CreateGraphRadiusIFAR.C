...
//TGraphErrors* CreateGraphRadiusIFAR (char* sim_file_name, char* mdc_file_name, float shell_volume, double liveTot=1e6, float T_ifar=0.0, float T_win=0.2, int TRIALS = 1, TString SEL="", Color_t color=kBlue, TString opt="default"){
...
//	float 
 ...
 // co_gr->GetYaxis()->SetRangeUser(MINRADIUS,MAXRADIUS);
  ...
  vifar.clear(); vdv.clear(); vrho.clear(); vsifar.clear(); vseifar.clear(); vsrho.clear(); 
