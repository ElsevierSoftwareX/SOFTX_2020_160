...
//fine defnizione start
   ...
   char nomeNN[512];
   sprintf(nomeNN,"NN/mlpNetwork_nTS%i_nTB%i_structure%s_lm%i_epochs%i_s%i_b%i_ROC_TREEfile%s.root",nTrain,nTrainBg,structure.Data(),lm,nepoch,q,p,TreeF.Data());
cout<<nomeNN<<endl;
   char nameTrain[512];
   sprintf(nameTrain,"PropertyGraphs/mlpNetwork_nTS%i_nTB%i_s%i_b%i_TREEfile_%s.root",nTrain,nTrainBg,q,p,TreeF.Data());
#ifdef RHO_CC
TString SIG_FILE;
TString BG_FILE;
char FILE_NAME[516];
