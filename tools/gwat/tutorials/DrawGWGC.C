...
//#define SKYMASK_FILE_NAME  "SkyMaskCC_BRST50MPC_S6_Rev1d7_R0d4_PROB.txt"
...
*/
#ifdef WRITE_PLOT
  char ofileName[256]="GWGCCatalog_Rev1d8_plot.png";

#ifdef SKYMASK_FILE_NAME
  TString ofileLabel = gSystem->ExpandPathName(SKYMASK_FILE_NAME);
