...
#  -----------------------------------------------------------------
  ...
  export HOME_LIBS="/home/waveburst/SOFT"

  
  
  export ROOT_VERSION="root_v6.14.06_icc"
  export ROOTSYS="${HOME_LIBS}/ROOT/${ROOT_VERSION}"

  
  
  export HOME_FRLIB="${HOME_LIBS}/FRAMELIB/libframe-8.33_root-6.14.06_icc"
...
#  -----------------------------------------------------------------
  ...
  export CWB_DOC_URL="https://www.atlas.aei.uni-hannover.de/~waveburst/waveburst/WWW/doc"
  export CWB_REP_URL="https://www.atlas.aei.uni-hannover.de/~waveburst/waveburst/WWW/reports"
  export CWB_GIT_URL="https://gitlab.com/gwburst"
  ...
  export CWB_USER_URL="https://www.atlas.aei.uni-hannover.de/~${USER}/LSC/reports"
...
#  -----------------------------------------------------------------
  ...
  export PATH=/opt/intel/2018/bin:${PATH}
